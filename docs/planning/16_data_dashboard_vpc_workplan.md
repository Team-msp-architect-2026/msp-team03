...
- docs/architecture/drawio/ 신규 다이어그램 ✅ 완료 — `agiespi_architecture_overview_final1.drawio` / `images/agiespi_architecture_overview_final3.drawio.png` 단일 overview로 통합. Cloud Infra Collector·notifier DLQ·OIDC 웹배포·RBAC·`CLOUD#infra`·`GRAPH#5M`·ECS Auto Scaling 반영 (ADR 0035)
