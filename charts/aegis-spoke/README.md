...
- publisher MQTT: persistent connection, Thing name client ID, QoS 1 ack 후 outbox 삭제
- publisher safety: `replicaCount=1`, Deployment `strategy=Recreate`
...
```text
edge-iot-publisher: 611058323802.dkr.ecr.ap-south-1.amazonaws.com/aegis/edge-iot-publisher:sha-36eae8c
snapshot-uploader: 611058323802.dkr.ecr.ap-south-1.amazonaws.com/aegis/snapshot-uploader:sha-6d30ef2
```

AWS IoT Fleet Indexing connectivity 기준은 `docs/ops/34_iot_fleet_connectivity.md`를 따른다.
